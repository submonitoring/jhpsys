...
class ModuleCaaResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('module_caa')
                    ->maxLength(255),
                Forms\Components\TextInput::make('module_caa_name')
                    ->maxLength(255),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('module_caa')
                    ->searchable(),
                Tables\Columns\TextColumn::make('module_caa_name')
                    ->searchable(),
